...
class FragmentAllGames : Fragment() {
    ...
    companion object {
        fun newInstance() = FragmentAllGames()
    }

    private lateinit var viewModel: FragmentAllGamesViewModel
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProvider(this).get(FragmentAllGamesViewModel::class.java)
